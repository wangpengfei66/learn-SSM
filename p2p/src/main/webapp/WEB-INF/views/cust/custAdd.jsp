            ...
            <form class="form-horizontal" id="addForm">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">姓名：(<span><strong class="text-danger">*</strong></span>)</label>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">银行卡号：(<span><strong class="text-danger">*</strong></span>)</label>
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">开户行：(<span><strong class="text-danger">*</strong></span>)</label>
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">生日：(<span><strong class="text-danger">*</strong></span>)</label>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea name="" id="remark" name="remark" value="${cust.remark}" class="form-control" rows="6"></textarea>
                  </div>
                </div>
